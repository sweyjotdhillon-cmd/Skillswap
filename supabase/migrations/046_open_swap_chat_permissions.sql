-- Migration 046: Open Swap Chat RLS and Authorization Update
-- Description: Enable authenticated non-requesters to message swap requesters for OPEN swaps
--              while preserving participant-only messaging for ACTIVE swaps and strict Realtime RLS.

-- 1. Update RLS policy on public.swap_messages for INSERT
...
-- 2. Update send_chat_message_with_attachments SECURITY DEFINER RPC
