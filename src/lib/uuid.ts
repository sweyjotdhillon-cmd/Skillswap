 ...
 * Uses `crypto.randomUUID()` if available (e.g., in Secure Contexts over HTTPS/localhost),
 * falling back to `crypto.getRandomValues()` for non-HTTPS or HTTP browser/worker contexts.
 */
